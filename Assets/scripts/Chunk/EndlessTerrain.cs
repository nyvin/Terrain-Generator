...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public class TerrainChunk
    {
        ...
        void OnChunkDataRecived(ChunkData chunkData)
        {
            ...
            Texture2D texture = TextureGenerator.TextureFromColorMap(ChunkGenerator.chunkSize, ChunkGenerator.chunkSize, chunkData.colorMap);
            ...
            if (chunkDataRecieved)
            {
                ...
                if (visible)
                {
                    ...
                    if(lodIndex == 0)
                    {
                        ...
                        {
                            collisionLODMesh.RequestMesh(chunkData);
                        }
                    }
